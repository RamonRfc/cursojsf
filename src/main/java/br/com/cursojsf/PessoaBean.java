...
public class PessoaBean {
	...
	public String logar() {  
		...
		if(pessoaUser != null) { //se achar o usuário vai para a página desejada
			//Adicionando usuário logado na sessão userLogado para passar pelo filter
			FacesContext context = FacesContext.getCurrentInstance();
			ExternalContext externalContext = context.getExternalContext();
			externalContext.getSessionMap().put("userLogado", pessoaUser);
		...
		public void carregaCidades(AjaxBehaviorEvent event) {
			...
			if (estado != null) {
				...
				List<Cidades> cidades = JPAUtil.getEntityManager().createQuery("from Cidades where estados.id = " + estado.getId())
						.getResultList();
